...
struct Recipes {
    ...
    static func getRecipe()->[Recipes] {
        return [
            ...
            Recipes(recipeName: "Спагетти", recipeAuthor: "С.Петров", recipeRating: 0.3, recipeText: "Спагетти - 250 г,Куриные бедра - 2 шт., Помидоры измельченные или томатный сок - 200 мл, Чеснок - 1 зубчик, Лук репчатый - 1 шт., Сыр твертый - 30 г", recipeIcon: "ic_spagetti", recipeImage: "im_spagetti"),
